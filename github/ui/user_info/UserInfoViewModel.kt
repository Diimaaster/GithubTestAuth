...
class UserInfoViewModel(application: Application): AndroidViewModel(application) {
    ...
    private val userRepoMutableStateFlow = MutableStateFlow<Response<List<GitHubRepos>>?>(null)
    ...
    val userRepoFlow: Flow<Response<List<GitHubRepos>>?>
        get() = userRepoMutableStateFlow.asStateFlow()
    ...
    fun loadUserInfo() {
        viewModelScope.launch {
            ...
            runCatching {
                ...
                toastEventChannel.trySendBlocking(R.string.get_user_info)
            }.onFailure {
                loadingMutableStateFlow.value = false
            ...
            runCatching {
                ...
                userRepoMutableStateFlow.value = it
                loadingMutableStateFlow.value = false
                toastEventChannel.trySendBlocking(R.string.get_user_info)
            }.onFailure {
                loadingMutableStateFlow.value = false
                userRepoMutableStateFlow.value = null
                toastEventChannel.trySendBlocking(R.string.get_user_error)
            }
        }
    }
